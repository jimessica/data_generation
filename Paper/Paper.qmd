...
To simulate the data, I first set the seed at 250 and then created a normal distribution with 900 observations and a mean and standard deviation of one by using rnorm(). Next, I needed to duplicate the first 100 observations and duplicate them. To do so, I created a variable of the first 100 observations and created a completed sample of the initially simulated and repeated data called full_sample.
